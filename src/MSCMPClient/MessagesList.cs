...
namespace MSCO {
	...
	/// <summary>
	/// simple timer made to clear message box
	/// </summary>
	...
	public static class MessagesList {
		...
		/// <summary>
		/// Timer to clear chat in 10 seconds
		/// </summary>
		public static void Timer()
		{
			aTimer.Elapsed += new ElapsedEventHandler(ClearMessages);
		...
		/// Clear chat.
		/// </summary>
		public static void ClearMessages(object source, ElapsedEventArgs e) {
